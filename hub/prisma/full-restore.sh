...
\copy users_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/users.csv' WITH (FORMAT csv, HEADER true, NULL '');
...
\copy projects_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/projects.csv' WITH (FORMAT csv, HEADER true, NULL '');
...
\copy cols_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/project_columns.csv' WITH (FORMAT csv, HEADER true, NULL '');
...
\copy pu_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/project_users.csv' WITH (FORMAT csv, HEADER true, NULL '');
INSERT INTO "ProjectUser" (id, "userId", "projectId", role, "createdAt", "updatedAt")
SELECT "id", "userId", "projectId", "role", "createdAt", "updatedAt" FROM pu_csv;
SELECT COUNT(*) as project_users FROM "ProjectUser";
SQL
...
CREATE temp TABLE tasks_csv (
  "id" int, "name" text, "description" text, "projectId" int, "projectColumnId" int,
  "assigneeId" int, "createdById" int, "order" int, "identifier" text,
  "relationMode" text, "relationId" int, "parentId" int, "isContainer" bool,
  "planAccepted" bool, "subBoardOutlineColor" text, "createdAt" timestamptz, "updatedAt" timestamptz
);
\copy tasks_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/tasks.csv' WITH (FORMAT csv, HEADER true, NULL '');
...
\copy comments_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/task_comments.csv' WITH (FORMAT csv, HEADER true, NULL '');
INSERT INTO "TaskComment" (id, "taskId", "userId", content, "createdAt", "updatedAt")
SELECT "id", "taskId", "userId", NULLIF("content", '')::text, "createdAt", "updatedAt" FROM comments_csv;
...
\copy logs_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/task_logs.csv' WITH (FORMAT csv, HEADER true, NULL '');
INSERT INTO "TaskLog" (id, "taskId", "userId", text, "createdAt", "updatedAt")
SELECT "id", "taskId", "userId", NULLIF("text", '')::text, "createdAt", "updatedAt" FROM logs_csv;
...
\copy docs_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/project_documents.csv' WITH (FORMAT csv, HEADER true, NULL '');
...
if [ -s /home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/task_document_links.csv ]; then
  psql "$DB_URL" <<'SQL'
CREATE temp TABLE links_csv (
  "id" int, "projectId" int, "taskId" int, "documentId" int,
  "role" text, "pinnedVersion" int, "createdAt" timestamptz, "createdBy" int
);
\copy links_csv FROM '/home/james/kanban_frontend/Kanban-rewrite/prisma/DATADUMP/task_document_links.csv' WITH (FORMAT csv, HEADER true, NULL '');
